...
train_val_idx, test_idx = next(sgkf.split(df,y=df["label"],groups=df["review_id"]))
...
train_idx, val_idx = next(sgkf2.split(train_val_df,y=train_val_df["label"],groups=train_val_df["review_id"]))
